...
fn main() {
	...
	let ti_sdk_env = env::var("MSPM0_SDK_PATH").expect("Cannot compile without MSPM0 SDK accessible.");
    ...
    cc::Build::new()
		...
		.include(crate_dir.join("../freertos_builds_LP_MSPM0G3507_release_ticlang").canonicalize().expect("Project layout changed?"))
		.static_flag(true)
