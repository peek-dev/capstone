 ...
 *
 * button-v1.c: provides button mapping structures for the button driver.
 *
...
const enum button_num prvButton_ButtonsB[PRVBUTTON_LENB] = {button_num_undo, button_num_pause};
